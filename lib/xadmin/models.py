...
class Bookmark(models.Model):
    ...
    user = models.ForeignKey(AUTH_USER_MODEL, verbose_name=_(u"coustmer"), blank=True, null=True)
...
class UserSettings(models.Model):
    user = models.ForeignKey(AUTH_USER_MODEL, verbose_name=_(u"coustmer"))
