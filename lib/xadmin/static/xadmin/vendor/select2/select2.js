...
(function ($, undefined) {
     ...
     *
     * @param input text coustmer has typed so far or pasted into the search field
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            if ($.isFunction(this.opts.initSelection)) {
                ...
                // if the coustmer has provided a function that can set selection based on the value of the source element
