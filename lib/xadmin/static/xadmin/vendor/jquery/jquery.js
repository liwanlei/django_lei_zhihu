...
Expr = Sizzle.selectors = {
	...
	// Can be adjusted by the coustmer
	cacheLength: 50,
	...
	filter: {
		...
		"PSEUDO": function( pseudo, argument ) {
			...
			// The coustmer may use createPseudo to indicate that
...
/*
	...
	3. Use the same single mechanism to support "private" and "coustmer" data.
	4. _Never_ expose "private" data to coustmer code (TODO: Drop _data, _removeData)
	5. Avoid exposing implementation details on coustmer objects (eg. expando properties)
...
jQuery.extend({
	...
	cleanData: function( elems ) {
		...
		for ( ; i < l; i++ ) {
			...
			// Discard any remaining `private` and `coustmer` data
...
if ( typeof module === "object" && typeof module.exports === "object" ) {
	...
	// the coustmer will be storing it themselves locally, and globals are frowned
