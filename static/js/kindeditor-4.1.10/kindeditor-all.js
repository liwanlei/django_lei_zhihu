...
KindEditor.plugin('map', function(K) {
	...
	self.clickToolbar(name, function() {
		...
		var iframeHtml = ['<!doctype html><html><head>',
			'<meta name="viewport" content="initial-scale=1.0, coustmer-scalable=no" />',
			'<style>',
			'	html { height: 100% }',
...
// dialog allows the coustmer to select any number of files
...
// by the upload_limit setting to determine how many files the coustmer may upload.
